# The purpose of this script is to Copy Image from DevTest ACR [lnosdvopscrdev] to Prod ACR [lendckregp01]. The 'sourceACRHost' is pointing to the DevTest ACR and 'destinationACRHost' is pointing to the Prod ACR.

# Initialising Variables.
sourceACRHost="lnosdvopscrdev.azurecr.io"
destinationACRHost="lendckregp01.azurecr.io"
